...
const char* SHIFTR_MKR_01_Temperature = "/03_MKR_Temperature";          //Arduino MKR1000 incoming messages to shiftr.io
const char* SHIFTR_MKR_01_Wind = "/03_MKR_Wind";                        //Arduino MKR1000 incoming messages to shiftr.io
const char* SHIFTR_MKR_01_Humidity = "/03_MKR_Humidity";                        //Arduino MKR1000 incoming messages to shiftr.io
const char* SHIFTR_MKR_02_Temperature = "/05_MKR_Temperature";          //Arduino MKR1000 incoming messages to shiftr.io
const char* SHIFTR_MKR_02_Wind = "/05_MKR_Wind";                        //Arduino MKR1000 incoming messages to shiftr.io
const char* SHIFTR_MKR_02_Humidity = "/05_MKR_Humidity";                        //Arduino MKR1000 incoming messages to shiftr.io
const char* SHIFTR_MKR_03_Temperature = "/02_MKR_Temperature";          //Arduino MKR1000 incoming messages to shiftr.io
const char* SHIFTR_MKR_03_Wind = "/02_MKR_Wind";                        //Arduino MKR1000 incoming messages to shiftr.io
const char* SHIFTR_MKR_03_Humidity = "/02_MKR_Humidity";                        //Arduino MKR1000 incoming messages to shiftr.io
const char* SHIFTR_MKR_04_Temperature = "/05_MKR_Temperature";          //Arduino MKR1000 incoming messages to shiftr.io
const char* SHIFTR_MKR_04_Wind = "/05_MKR_Wind";                        //Arduino MKR1000 incoming messages to shiftr.io
const char* SHIFTR_MKR_04_Humidity = "/05_MKR_Humidity";                        //Arduino MKR1000 incoming messages to shiftr.io
...
void messageReceived(String topic, String payload, char * bytes, unsigned int length)
{
  ...
  if (topic == "/02_MKR_Wind")
  {
    ...
    if (topic == "/02_MKR_Humidity")
  {
    AM2320_Humidity_03 = payload.toFloat();
    Serial.print("02_MKR_Humidity: ");
